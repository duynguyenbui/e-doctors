...
export const post1: Partial<Post> = {
          ...
          children: [
            {
              ...
              mode: 'normal',
              style: '',
              text: 'Chúng ta đang sống trong một kỷ nguyên chuyển đổi, nơi trí tuệ nhân tạo (AI) đứng ở tuyến đầu của sự tiến hóa công nghệ. Tác động lan tỏa từ những tiến bộ của nó đang định hình lại các ngành công nghiệp với tốc độ chưa từng có. Các doanh nghiệp không còn bị giới hạn bởi những quy trình thủ công tẻ nhạt. Thay vào đó, các máy móc tinh vi, được cung cấp bởi lượng lớn dữ liệu lịch sử, giờ đây có khả năng đưa ra những quyết định trước đây chỉ dựa vào trực giác của con người. Những hệ thống thông minh này không chỉ tối ưu hóa hoạt động mà còn tiên phong trong các phương pháp tiếp cận đổi mới, báo hiệu một kỷ nguyên mới của sự chuyển đổi kinh doanh trên toàn cầu.',
              version: 1,
            },
          ],
          direction: 'ltr',
  ...
  meta: {
    ...
    // @ts-ignore
    image: '{{IMAGE_1}}',
    title: 'Chân Trời Số: Cái Nhìn Thoáng Qua về Tương Lai',
  },
