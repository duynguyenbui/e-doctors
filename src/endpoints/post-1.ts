...
export const post1: Partial<Post> = {
          ...
          children: [
            {
              ...
              mode: 'normal',
              style: '',
              text: 'Khám phá những tiến bộ trong chăm sóc sức khỏe hiện đại, nơi công nghệ và y học hội tụ để cải thiện cuộc sống.',
              version: 1,
            },
          ],
          direction: 'ltr',
                ...
                children: [
                  {
                    ...
                    children: [
                      ...
                      },
                      {
                        ...
                        mode: 'normal',
                        style: '',
                        text: ' Nội dung này được tạo ra chỉ nhằm mục đích minh họa. Để chỉnh sửa bài viết này, ',
                        version: 1,
                      },
                      {
                        type: 'link',
          ...
          children: [
            {
              ...
              mode: 'normal',
              style: '',
              text: 'Sự Phát Triển của Công Nghệ Y Tế',
              version: 1,
            },
          ],
          direction: 'ltr',
          ...
          children: [
            {
              ...
              mode: 'normal',
              style: '',
              text: 'Chúng ta đang sống trong một kỷ nguyên chuyển đổi, nơi công nghệ y tế đứng ở tuyến đầu của sự tiến hóa. Tác động lan tỏa từ những tiến bộ của nó đang định hình lại các ngành công nghiệp y tế với tốc độ chưa từng có. Các bệnh viện và phòng khám không còn bị giới hạn bởi những quy trình thủ công tẻ nhạt. Thay vào đó, các máy móc tinh vi, được cung cấp bởi lượng lớn dữ liệu lịch sử, giờ đây có khả năng đưa ra những quyết định trước đây chỉ dựa vào trực giác của con người. Những hệ thống thông minh này không chỉ tối ưu hóa hoạt động mà còn tiên phong trong các phương pháp tiếp cận đổi mới, báo hiệu một kỷ nguyên mới của sự chuyển đổi y tế trên toàn cầu.',
              version: 1,
            },
          ],
          direction: 'ltr',
  ...
  meta: {
    description:
      'Khám phá những tiến bộ trong chăm sóc sức khỏe hiện đại, nơi công nghệ và y học hội tụ để cải thiện cuộc sống.',
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    image: '{{IMAGE_1}}',
    title: 'Chăm Sóc Sức Khỏe: Cái Nhìn Thoáng Qua về Tương Lai',
  },
